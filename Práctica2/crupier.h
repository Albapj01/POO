...
class Crupier : public Persona //La clase crupier hereda la parte publica de la clase persona 
{
	...
	public: //En esta parte guardamos las funciones
		...
		inline string getCodigo() const {return codigo_;}; //Devuelve el codigo de un crupier
		inline void setCodigo(string const &codigo){codigo_=codigo;}; //Modifica el codigo del crupier asignandole uno nuevo
