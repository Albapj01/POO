...
public: //En esta parte guardamos las funciones
	...
	inline string getCodigo() const {return codigo_;}; //Devuelve el codigo que contiene un jugador
	inline void setCodigo(string const &codigo){codigo_ = codigo;}; //Modifica el codigo que contiene un jugador
	inline int getDinero() const {return dinero_;}; //Devuelve el dinero que contiene un jugador
	inline void setDinero(int const &dinero){dinero_ = dinero;}; //Modifica el dinero que contiene un jugador
	inline list <Apuesta> getApuestas() const {return apuestas_;} //Devuelve la lista con la informacion del struct creado anteriormente
