...
public: //En esta parte guardamos las funciones
	...
	inline int getDado1() const {return d1_;}; //Devuelve el valor del dado 1
	inline int getDado2() const {return d2_;}; //Devuelve el valor del dado 2
	inline int getSuma() const {return (d1_+d2_);}; //Devuelve la suma de ambos dados
