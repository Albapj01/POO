...
public: //En esta parte guardamos las funciones
	...
	inline friend istream& operator>>(istream &o, Dados &c) //Aqui hacemos el extractor
	{
		cout<<"Introduzca el valor del dado 1:"<<endl;
		o>>c.d1_;
		cout<<"Introduzca el valor del dado 2:"<<endl;
		o>>c.d2_;

		return o;
	}

	inline friend ostream& operator<<(ostream &o, Dados &c) //Aqui hacemos el insertador
	{
		o<<"El valor del dado 1 es "<<c.d1_<<" y el del dado 2 es "<<c.d2_<<endl;
